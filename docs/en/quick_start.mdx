...
export const WebCliIcon = () => (
  <span style={{ whiteSpace: 'nowrap' }}>
    <img src={terminalIcon} alt="Web CLI terminal icon" width="20" height="20" style={{ display: 'inline-block', verticalAlign: 'middle' }} /> <strong>Web CLI</strong> terminal icon
  </span>
)
...
Click the <WebCliIcon /> in the top-right corner of the platform page. Web Terminal opens as its own session page:
